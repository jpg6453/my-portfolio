...
export default function About() {
  return (
    <section id='about'>
      <div className='container mx-auto flex px-2 py-12 md:p-6 lg:px-24 lg:py-10 xl:px-28 xl:py-20 lg:flex-row flex-col items-center md:mt-20'>
        <div className='lg:flex-grow md:w-full lg:pr-24 flex flex-col md:items-center md:text-center lg:items-start lg:text-left mb-16 md:mb-8 items-start text-left'>
          <h1 className='title-font font-extrabold trackin-tight md:text-6xl text-4xl xl:text-6xl mb-4 text-white'>
